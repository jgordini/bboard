...
func (s Service) Init() {
	...
	bus.AddHandler(flagComment)
	bus.AddHandler(setCommentPinned)
	bus.AddHandler(getCommentFlagsCount)
	bus.AddHandler(getCommentFlagsCountsForPost)
	bus.AddHandler(getFlaggedComments)
	bus.AddHandler(clearCommentFlags)
	bus.AddHandler(getCommentPostID)
